...
const RoomDetailsPage = () => {
    ...
    useEffect(() => {
        const fetchRoomDetails = async () => {
            try {
                const resp = await ApiClient.getRoomById(roomId);
                setRoom(resp.room);
            } catch (error) {
                console.log(error);
            }
    ...
    const acceptBooking = async () => {
        ...
        try {
            ...
            const resp = await ApiClient.bookRoom(booking);
    ...
    return (
        <div className="room-details-booking">
            ...
            {/* Room Details */}
            <h2>Room Details</h2>
            <img className="room-details-image" src={imageUrl} alt={type}/>
                ...
                {showDatePicker && (
                    <div className="date-picker-container">
                        ...
                        <div className="confirm-booking">
                            <button className="confirm-booking-btn" onClick={handleConfirmation}>
                                Proceed
                                <TbArrowBigRightLineFilled className="btn-icon" />
                            </button>
                        </div>
                    </div>
                )}
