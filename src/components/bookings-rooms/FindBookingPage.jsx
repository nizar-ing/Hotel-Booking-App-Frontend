...
import ApiClient from "../../services/ApiClient.js"; // Assuming your service is in a file called ApiService.js
...
const FindBookingPage = () => {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            const response = await ApiClient.getBookingByReference(confirmationCode);
